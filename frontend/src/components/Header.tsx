            ...
            {isLoaded && (
              <>
                ...
                <Button onClick={() => navigate('/')} className="logo">
                  <img 
                    src="/drivenow-logo.png" 
                    alt="DriveNow Car Rentals" 
                    onError={(e) => {
