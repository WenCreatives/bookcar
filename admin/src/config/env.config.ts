...
const env = {
  ...
  CURRENCIES,
  BASE_CURRENCY: String(import.meta.env.VITE_BC_BASE_CURRENCY || 'KES'),
  MAP_LATITUDE: Number(String(import.meta.env.VITE_BC_MAP_LATITUDE || '-1.286389')),
  MAP_LONGITUDE: Number(String(import.meta.env.VITE_BC_MAP_LONGITUDE || '36.817223')),
  ...
  CURRENCY: import.meta.env.VITE_BC_CURRENCY || 'KSh',
